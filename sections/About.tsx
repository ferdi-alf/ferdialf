...
const cardData: BentoCardProps[] = [
  {
    color: "#000000",
    title: "About Me",
    description: "A quick look at who I am",

    children: (
      <div className="absolute scale-75 top-0 right-2 flex justify-start mt-2 items-center flex-col h-full w-full  border-none mask-[linear-gradient(to_top,transparent_10%,#000000_90%)] transition-all duration-300 ease-out group-hover:scale-90">
        <p className="text-white pl-10 md::text-xl font-light">
          I’m Muhammadd Ferdi Alfian, a fullstack developer passionate about
          building clean, responsive, and meaningful web experiences.
        </p>
      </div>
    ),
  },
...
const About: React.FC<BentoProps> = ({
  textAutoHide = true,
  enableStars = true,
